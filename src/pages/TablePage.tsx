...
function TablePage() {
  ...
  function onSortAsset(list: Data[], sortKey: keyof Data, sortDir: `${Sorting}`) {
  ...
  return <>
    <Table className="shadow-lg bg-white border-collapse table-auto max-h-[800px] overflow-y-auto block">
      <Table.Header {...sorting} className="bg-gray-50 border-b sticky top-0">
        <Table.Column className="px-6 py-3" id="ticker">Ticker</Table.Column>
        <Table.Column className="px-6 py-3" id="price">Price</Table.Column>
        <Table.Column className="px-6 py-3" id="assetClass">Asset</Table.Column>
      </Table.Header>
